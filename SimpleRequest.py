...
from env import ACCESS_TOKEN, REGNUM, KEY_PATH
service_name = "WS100401_getVehicleInfo"
...
citizen = Service(wsdl_url, ACCESS_TOKEN, KEY_PATH)
citizen.dump(service_name, params)