...
class Service:
    ...
    def __init__(self, wsdl_url: str, timestamp: str):
        # 1) ACCESS_TOKEN + timestamp дээр подпись үүсгэх
        signer = XypSign(KEY_PATH)
        to_be_signed, signature = signer.sign(ACCESS_TOKEN, timestamp)
        # Debug хэвлэх (шаардлагатай бол гүйцэтгэхэд харах)
        print("---- DEBUG ----")
        ...
        # 2) HTTP session үүсгэн, SSL шалгалтыг түр хасах, сертификат+private key-ээ тохируулах
    ...
    def get_vehicle_info(self, plate_number: str):
        """
        WS100401_getVehicleInfo operation
        """
